...
class CFila {
	...
	public int mostra() {
		...
		for (CCelula c = frente.prox; c != tras; c = c.prox){
			somatorio += c.item.getSeasons();
            contagem++;
        }
        somatorio += tras.item.getSeasons();
        contagem++;

        media = (float)somatorio / (float)contagem;
	 ...
	 * 
	 * @param valorItem O parametro "valorItem" � um Serie contendo o elemento a
	 ...
	 * 
	 * @return Retorna um Serie contendo o primeiro elemento da fila. Caso a fila
	 ...
	 * 
	 * @return Retorna um Serie contendo o primeiro Item da fila.
	 */
	public Serie peek() {
		if (frente != tras)
	 ...
	 * 
	 * @param valorItem O parametro "valorItem" e um Serie contendo o Item a ser
	 *                  localizado.
	 ...
	 * comando FOR)
	 * 
	 * @param (valorItem) Recebe como parametro um Serie contendo o Item a ser
	 *                    localizado.
...
public class Main{
    ...
    public static void main(String [] args){
        ...
        CFila filaDinamica = new CFila();//Cria um array de filas
        ...
        while(true){
            ...
            filaDinamica.enfileira(serie);
            System.out.println(filaDinamica.mostra());
            inputNumber ++;
        }
        ...
        for(int i = 0; i < breakpoint; i++){
            ...
            //Caso o comando dado seja REMOVER
