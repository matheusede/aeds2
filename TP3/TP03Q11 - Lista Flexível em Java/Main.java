    ...
    public static void main(String [] args){
        ...
        for(int i = 0; i < breakpoint; i++){
            ...
            if((in[inputNumber].substring(0, 2)).equals("II") == true){
                ...
                listaDinamica.insereComeco(serie);
            }
            ...
            //Caso o comando dado seja INSERIR EM QUALUQER POISÇÃO 
                ...
                listaDinamica.insereIndice(serie, position+1);
            }
            ...
            //Caso o comando dado seja RETIRAR NO INICIO
                ...
                System.out.print("(R) ");
                serie = listaDinamica.removeRetornaComeco();
            ...
            //Caso o comando dado seja RETIRAR EM QUALQUER POSIÇÃO
                ...
                position = Integer.parseInt(in[inputNumber].substring(3, 5));
                System.out.print("(R) ");
                serie = listaDinamica.removeRetornaIndice(position+1);
                System.out.println(serie.getName());
            }
            ...
            //Caso o comando seja RETIRAR NO FIM
                ...
                System.out.print("(R) ");
                serie = listaDinamica.removeRetornaFim();
                System.out.println(serie.getName());
            }
            
        }
        listaDinamica.imprime();
        keyboard.close();
    }
