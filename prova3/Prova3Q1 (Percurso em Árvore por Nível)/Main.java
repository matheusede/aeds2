...
class ArvoreBinaria {
   ...
   public void printaNivel(No raiz, int level)
   {
       if (raiz == null)
           return;
       if (level == 1)
           ...
           printaNivel(raiz.esq, level - 1);
           printaNivel(raiz.dir, level - 1);
       }
   }
   ...
   public static void imprimeNivel(){
      Fila fila = new Fila();
   }
   ...
   public void printLevel(No node, int level)
   {
       if (node == null)
           return;
       if (level == 1)
...
class Main{
    public static void main(String args[]) throws Exception{
        ...
        limite = sc.nextInt(); //LÊ on número de casos
